...
const listUsage = "usage: sonora get|list outputs [--include-disabled] [--json] [--verbose] [--hub-url URL]"

// RunList implements `sonora get|list outputs`: it defines and parses this
